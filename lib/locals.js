...
var Locals = {
  ...
  /**
   * @property {Object} namespaces - The namespaces map
   */
  namespaces: {},
  ...
  get classes () {
    ...
    return Object.keys(self.ast.classes).map(
      function (name) {
        ...
        self.namespaces[clazz.namespace] = clazz;
        return clazz;
      }
    );
  },
  ...
  buildMember: function (member, forceBeMethod ,parent) {
    ...
    if (parent) {
      ...
      // set namespaces
      if (parent.namespace) {
        member.namespace = parent.namespace + '.' + member.name;
      } else {
        member.namespace = member.name;
      }
      self.namespaces[member.namespace] = member;
    }
  ...
  create: function (context) {
    ...
    instance.meta.namespaces = this.namespaces;
