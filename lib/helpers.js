...
exports.getRelativeUrl = function getRelativeUrl (item, options) {
  var sourceURL = this.options.sourceURL;
  var repo = sourceURL.repo;
...
exports.getSourceFile = function getSourceFile (item, options) {
  var sourceURL = this.options.sourceURL;
  var org = sourceURL.org, repo = sourceURL.repo, commitId = sourceURL.commitId;
  var path = require('path');
  var relativePath = exports.getRelativeUrl.call(this, item, this.options);
  var baseStr = `https://github.com/${org}/${repo}/blob/${commitId}/` + relativePath;
  return baseStr;
};
