...
YUI.add('doc-builder', function (Y) {
  ...
  Y.DocBuilder.prototype = {
    ...
    buildAPI: function () {
      var self = this;
      var opts = Y.prepare([DEFAULT_THEME, themeDir], self.getProjectMeta());
      ...
      opts.meta.files = self.files;

      try {
        require(self.options.themedir + 'locals.js')(
          opts.meta.modules, opts.meta.classes, opts.meta);
      } catch (e) {
        // skiped the locals
      }
      return opts;
    ...
    renderModule: function (cb, data, layout) {
      ...
      Y.prepare([DEFAULT_THEME, themeDir], self.getProjectMeta(), function (err, opts) {
        ...
        // console.log(self.api.meta.modules[0]);
